...
class LLMWildcardManager:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                # brief step is skipped. When OFF, the brief is regenerated by
                # the LLM on every queue (user edits to the brief are ignored).
                "lock_brief": ("BOOLEAN", {
                    "default": True,
                    "tooltip": (
    ...
    def manage(self, server, example_prompt, lock_template, seed, direction,
               ...
               design_brief="", lock_brief=True, structure=None):
